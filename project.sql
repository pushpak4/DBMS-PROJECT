/*Tejaswi Koppula creating new database and verify modified, inserted data in table using select command.*/  

create database Project;
\l
\c Project;

/*Ashish Sudam Creating 3-Tables with all keys and attribute.*/
...
/*Chandu Pentela entering data in product table.*/
...
/*Maneesha Narahari entering data in depot table.*/
...
/*Pushpak Kamisetti entering data in stock table.*/ 
...
/*Maneesha Narahari first transaction, We add a depot (d100, Chicago, 100) in Depot and (p1, d100, 100) in Stock.*/ 
begin;
...
/*Chandu Pentela second transaction, The depot d1 changes its name to dd1 in Depot and Stock.*/
begin;
...
/*Tejaswi Koppula Third transaction, The depot d1 is deleted from Depot and Stock.*/
begin;
...
/*Ashish Sudam fourth transaction,The product p1 changes its name to pp1 in Product and Stock.*/
begin;
...
/*Pushpak Kamisetti fifth transaction, We add a product (p100, cd, 5) in Product and (p100, d2, 50) in Stock.*/
begin;
